...
router.post(
  ...
  transaksiDetailController.createTransaksiDetail
);
router.put(
  "/update-transaksi-detail/:id",
  transaksiDetailController.updateTransaksiDetail
);
router.delete(
  "/delete-transaksi-detail/:id",
  transaksiDetailController.deleteTransaksiDetail
);
